      ...
      <div className={styles.reviewSlideContainer}>
        {reviewListData.products.map(product => (
          <div className={styles.reviewSlide} key={product.uuid}>
            <a
              onClick={() => onClickEvent()(product.productName)}
              className={styles.reviewCardArea}
            >
              <Card type="vertical">
                <Card.Thumb id={product.uuid} image={product.image} name={product.productName} />
                <Card.Content>
                  <Card.Content.Title
            ...
            <div className={styles.reviewContent}>
              <p className="text-ellipsis ellipsis-row-3">{product.reviewInfo[0].text}</p>
